...
find /Dealer_Schedules_0310 -type f \( -iname '*0310*' -o -iname '*0312*' -o -iname '*0315*' \) -exec mv -t $DealerAnalysis {} +

#2
# Move matching date files to Player_Analysis folder
# Execute in Roulette_Player_WinLoss_0310 folder
find -type f \( -iname '*0310*' -o -iname '*0312*' -o -iname '*0315*' \) -exec mv -t $PlayerAnalysis {} +
